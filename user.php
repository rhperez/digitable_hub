...
$json_user = json_decode(execute_graphQL_query(getUser($login)));
if ($json_user->data && $json_user->data->user) {
  $json_user = $json_user->data->user;
  $name = $json_user->name;
  $bio = $json_user->bio;
  $company = $json_user->company;
  $avatar_url = $json_user->avatarUrl;
  $email = $json_user->email;
  $location = $json_user->location;
  $created_at = $json_user->createdAt;
  $updated_at = $json_user->updatedAt;
  $website_url = $json_user->websiteUrl;
}
 ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="">
  <div class="wrapper">
    ...
    <div class="sidebar-wrapper">
      ...
      <ul class="nav">
        <li class="active ">
          <a class="octicon-active" href="./dashboard.php">
            <i class="octicon octicon-dashboard"></i>
            <p>Panel de Control</p>
          </a>
        </li>
        <li>
          <a class="octicon-a" href="./organizaciones.php">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Username" value="<?php echo $login;?>">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" placeholder="Here can be your description" value="Mike"><?php echo $bio;?></textarea>
                      </div>
                    </div>
                  </div>
                </form>
